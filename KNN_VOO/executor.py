...
class KNN_Executor():
    ...
    # Train Model
    def run_model(self, model_filename, date):
        # Loading model
        cur_dir = os.getcwd()
        model_filename = os.path.join(cur_dir, 'KNN_VOO\\Models', model_filename)
...
# knn_executor.train('VOO_2020-01-01_2025-01-01.pkl', '2020-01-01', '2025-01-01')
print(knn_executor.run_model('VOO_2020-01-01_2025-01-01.pkl', '2013-11-11'))
del knn_executor
